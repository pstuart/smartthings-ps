 ...
 */
metadata {
	definition (name: "Insteon Moisture (LOCAL)", namespace: "pstuart", author: "patrick@patrickstuart.com") {
		capability "Switch"
		capability "Sensor"
		capability "Actuator"
	...
	// UI tile definitions
	tiles {
		standardTile("water", "device.water", width: 2, height: 2, canChangeIcon: false) {
